<?php
    ...
    class FS_Admin_Notice_Manager
    {
         ...
         * @param bool            $store
         */
        public function remove_sticky($ids, $store = true)
        {
            if (! is_array($ids)) {
                $ids = array( $ids );
            }
         ...
         * @param array       $data
         */
        public function add_sticky($message, $id, $title = '', $type = 'success', $wp_user_id = null, $plugin_title = null, $is_network_and_blog_admins = false, $is_dimissible = true, $data = array())
        {
         ...
         */
        public function clear_all_sticky($is_temporary = false)
        {
            if ($is_temporary) {
                $this->_notices = array();
            } else {
