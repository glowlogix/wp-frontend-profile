<?php
    ...
    class FS_Api
    {
         ...
         */
        public static function remote_request($url, $remote_args)
        {
            if (! class_exists('Freemius_Api_WordPress')) {
                require_once WP_FS__DIR_SDK . '/FreemiusWordPress.php';
            }
        ...
        private function toggle_force_http($is_http)
        {
            ...
            if ($is_http) {
                Freemius_Api_WordPress::SetHttp();
            } elseif (method_exists('Freemius_Api_WordPress', 'SetHttps')) {
         ...
         * @return bool
         */
        public static function is_blocked($response)
        {
            return (
         ...
         * @since  2.5.4
         */
        public static function clear_force_http_flag()
        {
         ...
         * @return bool Is API result contains an error.
         */
        public static function is_api_error_object($result, $ignore_message = false)
        {
            return (
                is_object($result) &&
                isset($result->error) &&
         ...
         * @return bool
         */
        public static function is_ssl_error_response($response)
        {
            $http_error = null;
