    ...
    <div class="wpfep-field<?php echo esc_attr($classes); ?>" id="wpfep-field-<?php echo esc_attr($field['id']); ?>">
        ...
        ?>
            ...
            ?>
                ...
                <textarea name="<?php echo esc_attr($tab_id); ?>[<?php echo esc_attr($field['id']); ?>]" rows="<?php echo absint(apply_filters('wpfep_textarea_rows', '5', $field['id'])); ?>" cols="50" id="<?php echo esc_attr($field['id']); ?>" class="regular-text" <?php echo ($field['disabled'] == true) ? "disabled" : "enabled";  ?>><?php echo esc_textarea($current_field_value); ?></textarea>
