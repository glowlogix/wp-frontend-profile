		...
		public static function status_report() {
			...
			<div class="wrap">
				...
				<table class="wpfep-status-table widefat">
					...
					<tr>
						<td data-export-label="<?php esc_attr_e( 'wpfep version', 'wpfep' ); ?>"><?php esc_attr_e( 'wpfep version', 'wpfep' ); ?>:</td>
					...
					<tr>
						<td data-export-label="<?php esc_attr_e( 'WP Debug Mode', 'wpfep' ); ?>"><?php esc_attr_e( 'WP debug mode', 'wpfep' ); ?>:</td>
						<td>
				...
				<table class="wpfep-status-table widefat" cellspacing="0">
					<thead>
					<tr>
						<th colspan="3" data-export-label="Server Environment"><h2><?php esc_attr_e( 'Server Environment', 'wpfep' ); ?></h2></th>
					</tr>
					</thead>
					<tbody>
					<tr>
					...
					<tr>
						<td data-export-label="<?php esc_attr_e( 'fsockopen/cURL', 'wpfep' ); ?>"><?php esc_attr_e( 'fsockopen/cURL', 'wpfep' ); ?>:</td>
						<td>
						<?php
					...
					<tr>
						<td data-export-label="<?php esc_attr_e( 'Multibyte String', 'wpfep' ); ?>"><?php esc_attr_e( 'Multibyte string', 'wpfep' ); ?>:</td>
						<td>
						<?php
